...
const dummyOrderSummaryResponse: { data: OrderSummary } = {
  data: {
    ...
    paid: false,
    payable: true,
    cart_total_initial: { net: '100', gross: '121', vat_rate: '21', currency: 'pln' },
    cart_total: { net: '100', gross: '121', vat_rate: '21', currency: 'pln' },
    shipping_price_initial: { net: '100', gross: '121', vat_rate: '21', currency: 'pln' },
    shipping_price: { net: '100', gross: '121', vat_rate: '21', currency: 'pln' },
    summary: { net: '100', gross: '2134', vat_rate: '21', currency: 'pln' },
